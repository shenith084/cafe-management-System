...
$sql = "SELECT price, sum(qty) as sqty, pid FROM sales WHERE date LIKE '{$date}%' GROUP BY pid";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Monthly Income
                            <a href="income" class = "btn btn-primary ml-3" style = "background:#8f93e7;">View Daily Income</a>
                        </h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header">
                            ...
                            <div class="row">
                                ...
                                <input type="month" class="form-control" placeholder="select month" name = "monthselect">
                                </div>
                                <div class="col">
                                <label for=""><br></label>
    ...
    <script>
        window.onload = function () {
            ...
            .addEventListener("click", () => {
                ...
                var opt = {
                    margin: 0.2,
                    filename: '<?php echo $date;?> Monthly Income.pdf',
